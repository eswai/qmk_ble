...
const naginata_keymap_unicode ngmapu[] = {
  // 編集モード2
#ifdef NAGINATA_EDIT_WIN
...
const naginata_keymap_ime ngmapi[] = {
  // 編集モード2
#ifdef NAGINATA_EDIT_MAC
